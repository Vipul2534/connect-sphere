...
const LoginPage = () => {
  ...
  {/*state valiable to store true or false that indicated successful submisstion of fullName, pwd and email so that the user can then enter bio */}
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {/* when currstate is signup and datasubmitter is false then only fullName input field will display  */}
        ...
        {!isDataSubmitted && (
          ...
          <input onChange={(e)=>setPassword(e.target.value)} value={password}
           type="password" placeholder='Password' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 foucs:ring-indigo-500'/> 
          </>
        )}
